...
export function initCarousel() {
  ...
  const prevBtn = document.querySelector(
    '.navigation-item[data-slider="prev"]'
  );
  const nextBtn = document.querySelector(
    '.navigation-item[data-slider="next"]'
  );
  ...
  function startAutoplay() {
    autoplayInterval = setInterval(() => scrollCarousel("next"), autoplayDelay);
  }
